...
from .views import CrearPerfilProfesional, ProfesionalDetailView, ProfesionalUpdateNuevoView
...
urlpatterns = [
    ...
    path('misdatos/profesional/actualizar/<int:pk>', ProfesionalUpdateNuevoView.as_view(),
         name='profesional-update')
